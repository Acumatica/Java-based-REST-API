...
public class DiscountItemDetail extends Entity {
  ...
  public DiscountItemDetail description(StringValue description) {
  ...
  **/
  ...
  public DiscountItemDetail inventoryID(StringValue inventoryID) {
